    ...
    constructor(client) {
        ...
        super(client, {
            ...
            examples: [
                ...
                '`event image http://www.mizahar.com/forums/gallery/pic.php?mode=large&pic_id=63580` Set the thumbnail image for the event to the image URL specified | Permissions required: [MANAGE_MESSAGES]',
...
//        }
    ...
    get_leaderboard(msg, mention, limit){
        ...
        var embed = {
            ...
            footer: {
                text: footer,
                icon_url: 'http://www.mizahar.com/forums/gallery/pic.php?mode=large&pic_id=63580'
            }
        };
    ...
    run_info(msg){
        ...
        var thumbnail = 'http://www.mizahar.com/forums/gallery/pic.php?mode=large&pic_id=63580';
